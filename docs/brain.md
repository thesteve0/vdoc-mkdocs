...
[Embeddings panel](fiftyone_concepts/app.html#app-embeddings-panel), where you can interactively
select points of interest and view the corresponding samples/labels of interest
in the [Samples panel](fiftyone_concepts/app.html#app-samples-panel), and vice versa.
...
[Model Zoo](data_and_models/model_zoo/index.html#model-zoo) that supports embeddings
...
[mobilenet model](data_and_models/model_zoo/models.html#model-zoo-mobilenet-v2-imagenet-torch) from the model
zoo, and the default [UMAP](https://github.com/lmcinnes/umap) dimensionality
reduction method.

In this setup, the scatterpoints in the
[Embeddings panel](fiftyone_concepts/app.html#app-embeddings-panel) correspond to images in the
...
automatically selected in the [Samples panel](fiftyone_concepts/app.html#app-samples-panel):
...
Did you know? You can [programmatically configure](fiftyone_concepts/app.html#app-spaces-python)
your Spaces layout!
...
then we create a [view](fiftyone_concepts/using_views.html#view-filtering) that restricts the visualization
to only objects in a subset of the classes. The scatterpoints in the
[Embeddings panel](fiftyone_concepts/app.html#app-embeddings-panel) correspond to objects, colored
by their `label`. When points are lasso-ed in the plot, the corresponding
object patches are automatically selected in the
[Samples panel](fiftyone_concepts/app.html#app-samples-panel):
...
provides a convenient [point-and-click interface](fiftyone_concepts/app.html#app-similarity) for
...
- Using the App’s [image similarity](fiftyone_concepts/app.html#app-image-similarity) UI to query
...
an active selection in the App, a [similarity icon](fiftyone_concepts/app.html#app-image-similarity)
...
In the example above, we specify a [zoo model](data_and_models/model_zoo/index.html#model-zoo) with which
...
[`sort_by_similarity()`](api/fiftyone.core.collections.html#fiftyone.core.collections.SampleCollection.sort_by_similarity "fiftyone.core.collections.SampleCollection.sort_by_similarity")
view stage to programmatically [construct a view](fiftyone_concepts/using_views.html#using-views) that
...
- Using the App’s [object similarity](fiftyone_concepts/app.html#app-object-similarity) UI to
...
[`Polyline`](api/fiftyone.core.labels.html#fiftyone.core.labels.Polyline "fiftyone.core.labels.Polyline"), or [`Polylines`](api/fiftyone.core.labels.html#fiftyone.core.labels.Polylines "fiftyone.core.labels.Polylines") format. See [this section](fiftyone_concepts/using_datasets.html#using-labels) for
...
[object patches view](fiftyone_concepts/app.html#app-object-patches) by clicking the patches icon
...
[similarity icon](fiftyone_concepts/app.html#app-object-similarity) will appear above the grid,
...
This means that you can index an entire [`Dataset`](api/fiftyone.core.dataset.html#fiftyone.core.dataset.Dataset "fiftyone.core.dataset.Dataset") once and then perform
searches on subsets of the dataset by
[constructing views](fiftyone_concepts/using_views.html#using-views) that contain the objects of
interest.
...
[CLIP model](data_and_models/model_zoo/models.html#model-zoo-clip-vit-base32-torch), you can also search by
arbitrary natural language queries
[natively in the App](fiftyone_concepts/app.html#app-text-similarity)!
...
[model zoo interface](data_and_models/model_zoo/api.html#model-zoo-add) that implements the
...
specifying a custom model from the [Model Zoo](data_and_models/model_zoo/index.html#model-zoo) to use to
...
Did you know? If you provided the name of a [zoo model](data_and_models/model_zoo/index.html#model-zoo)
...
pre-computed embeddings, specify a [zoo model](data_and_models/model_zoo/index.html#model-zoo) of your choice
...
[Model Zoo](data_and_models/model_zoo/index.html#model-zoo) to use to generate embeddings via the optional
