...
provides a convenient [point-and-click interface](user_guide/app.md#app-similarity) for
...
- Using the App’s [image similarity](user_guide/app.md#app-image-similarity) UI to query
...
an active selection in the App, a [similarity icon](user_guide/app.md#app-image-similarity)
...
- Using the App’s [object similarity](user_guide/app.md#app-object-similarity) UI to
...
[object patches view](user_guide/app.md#app-object-patches) by clicking the patches icon
...
[similarity icon](user_guide/app.md#app-object-similarity) will appear above the grid,
...
[natively in the App](user_guide/app.md#app-text-similarity)!
